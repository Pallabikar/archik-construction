...
const teamMembers = [
  {
    ...
    quote:
      "Every home we build carries a promise — of safety, quality, and lasting beauty. For me, it's not just about constructing spaces, but about creating environments where families feel secure, comfortable, and truly at home. Every corner, every detail, every brick matters, because we are shaping lives, not just buildings. Seeing the joy and excitement on our clients' faces when they step into their new spaces is the most rewarding part of what I do. I strive to ensure that every project meets the highest standards, blending care, precision, and reliability."
  },
  {
        ...
        {teamMembers.map((member, index) => (
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-4">
              <div
                className="h-16 w-16 shrink-0 rounded-full overflow-hidden border-2"
            ...
            {/* Quote */}
            <div className="relative" style={{ textAlign: "justify" }}>
              <div
